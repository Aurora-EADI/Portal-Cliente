---
description: "Use em qualquer repositório grande do grupo que tenha um grafo de conhecimento gerado (ex: via graphify) — consultar o grafo antes de grep manual/leitura exaustiva de arquivos para perguntas de arquitetura ou navegação de código.\n"
---
