...
export class CompaniesController {
  ...
  @ApiResponse({ status: 200, description: 'Lista de empresas com responsáveis retornada com sucesso' })
  ...
  @ApiResponse({ status: 200, description: 'Lista de empresas ativas retornada com sucesso' })
  ...
  @ApiResponse({ status: 200, description: 'Status da empresa atualizado com sucesso' })
  @ApiResponse({ status: 404, description: 'Empresa não encontrada' })
  ...
  @ApiResponse({ status: 200, description: 'Requisitos atualizados com sucesso' })
  @ApiResponse({ status: 404, description: 'Empresa não encontrada' })
  updateRequirements(
