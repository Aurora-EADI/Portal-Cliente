...
export class ServicesController {
  ...
  @ApiQuery({ name: 'includeInactive', required: false, description: 'Incluir serviços inativos', type: Boolean })
  ...
  @ApiResponse({ status: 200, description: 'Custo atual retornado com sucesso' })
  @ApiResponse({ status: 404, description: 'Serviço não encontrado' })
