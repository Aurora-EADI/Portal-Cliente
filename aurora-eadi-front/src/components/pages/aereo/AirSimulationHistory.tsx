...
export function AirSimulationHistory() {
    const router = useRouter();
    const { data: simulations, isLoading } = useAirSimulations();
    ...
    // Local filter by customer or number
                                    ...
                                    paginatedSimulations.map((sim) => {
                                        ...
                                        return (
                                            <tr
                                                ...
                                                onClick={() => router.push(`/aereo/simulador?id=${currentVersion?.id || sim.id}`)}
                                            >
